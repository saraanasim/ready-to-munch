    ...
    >
      <CardActionArea>
        <CardMedia
          ...
          width="100%"
          //   style={{ width: "100%" }}
          image={blog.img ? blog.img : defaultImg}
          alt="Loading"
        />
        <CardContent>
          <Typography id="blog_title">{blog.title}</Typography>
          <Typography id="blog_desc">{blog.description}</Typography>
          <div className="time_container_card">
            <BsClock className="btn_icon_card" />
            <Typography id="blog_uploadTime">{`${blog.uploadTime} minutes ago`}</Typography>
          </div>
        </CardContent>
      </CardActionArea>
    </Card>
